...
export const GpsButton: FC<GpsButtonProps> = ({ onPress }) => {
  return (
    <Pressable
      onPress={onPress}
      className="absolute bottom-4 right-4 w-[46px] h-[46px] flex justify-center items-center bg-gray-light rounded-[23px]"
    >
      <GpsIcon />
    </Pressable>
  );
...
const GpsIcon: FC = () => {
  return (
    <Svg width="20" height="22" viewBox="0 0 16 18" fill="none">
      ...
      />
      <Path
        d="M14.6578 8.5098C14.4285 5.0279 11.7757 2.23702 8.46605 1.99571V0.666672H7.53419V1.99571C4.22454 2.23702 1.57172 5.0279 1.34238 8.5098H0.0791016V9.49017H1.34238C1.57172 12.9721 4.22451 15.763 7.53416 16.0043V17.3333H8.46602V16.0043C11.7757 15.763 14.4285 12.9721 14.6578 9.49021H15.9211V8.50984H14.657
8V8.5098ZM8.00011 15.0413C4.83409 15.0413 2.25775 12.3308 2.25775 9C2.25775 5.66918 4.83409 2.95873 8.00011 2.95873C11.1661 2.95873 13.7425 5.66918 13.7425 9C13.7425 12.3308 11.1661 15.0413 8.00011 15.0413Z"
        fill="#FDF2F2"
      />
    </Svg>
  );
